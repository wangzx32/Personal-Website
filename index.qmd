...
- **Summary**: 
    - Developed automated ETL pipelines utilizing AWS Glue to streamline the extraction, transformation, and loading of job requisition and preprocessed data, enabling seamless integration with Machine Learning modeling processes.
    - Engineered a tokenization framework in Python to extract skill-based keywords from resume data, employing segmented K-Means Clustering on a dataset of over 15k+ resumes to enhance candidate profiling and matching accuracy.
    - Spearheaded the development of an automated profile matching system catering to over 10k+ job seekers and hiring entities. Implemented a multi-tenant scoring methodology to ensure personalized matches, optimizing recruitment processes.
...
- **Institute**: UCLA
- **Paper**: still working on it! <img src="img/SNice.svg.png" alt="Smile Icon" style="width:50px;height:50px;"> 
